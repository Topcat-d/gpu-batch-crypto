...
| [Signed export manifests](RECORD_MANIFESTS.md) | Python wheel: `batchcrypto.manifests.seal_manifest` / `open_manifest` | Python core + trusted signing callback; CPU by default | Experimental ordered hash-list profile |
